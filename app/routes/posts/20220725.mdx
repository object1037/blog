...
BMPにはインジケータ機能が用意されており、バッテリー残量や接続状況をledで表せるのでこれにも対応することにします。
...
![レイアウト](/images/layout-b35ccca-1502:578.png)
...
![キーマトリクス](/images/keymatrix-2666726-2682:972.png)
...
![バッテリー周りの回路](/images/power-fc2e8f2-2098:716.png)

#### BMP周り

BMPのピンに以下のようにつなぎます。

![BMP周りの回路](/images/bmp-ed2400e-2286:1150.png)
...
![PCBの設計](/images/pcb_design-b2912b6-2322:972.png)

## ケースを設計する

アクリル積層ケースを設計します。断面が以下のようになる感じにします。

![ケースの断面図](/images/case-a71663a-1956:440.png)
*3mm厚のアクリル(灰色)を積層し、ネジとスペーサーで固定。PCB(緑)は3mm厚のPORON(ピンク)でケースに固定する。*

PCBの外形データをもとに各層のアクリルの外形を決めます。リセットボタンや電源スイッチ、USBコネクタの部分に穴を開けておきます。

![ケースのアクリル](/images/acryl-182f180-2678:954.png)
*各層のアクリルの外形。左上が一番上の層、右下が一番下の層*

## PCBとアクリルを発注する

PCBは[JLCPCB](https://jlcpcb.com/)に、アクリルは[遊舎工房](https://yushakobo.jp/lasercut/)に発注します。

![届いたPCB](/images/pcb-25b4767-3840:2082.jpg)
*届いたPCB。JLCPCBの黒は実質マットブラックな模様*
...
![実装した様子(表)](/images/assembled_f-03645d4-3840:1707.jpg)

![実装した様子(裏)](/images/assembled_b-48ee543-3840:1703.jpg)
*部品を実装した様子*
...
![Denpa](/images/denpa-a69a93c-3840:2147.jpg)
*斧乃木余接みたいな色(DSA Simple Green)*

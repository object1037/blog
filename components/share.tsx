...
export default function Share({
  ...
  return (
    <div className="flex flex-row items-center px-2 py-3.5 mt-12 border-t border-ngray-300 dark:border-ngray-600">
      <p className="text-ngray-500 dark:text-ngray-400 mr-5 text-sm tracking-widest">
        SHARE
      </p>
      <div className="flex justify-start space-x-1.5">
        <a
          href={`https://twitter.com/share?url=${siteUrl}/posts/${date}&text=${title}｜${siteTitle}`}

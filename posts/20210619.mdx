...
<Im src="20210619/diode_complete.jpg" alt="ダイオードの取り付けが終わった状態" cap="ダイオードのはんだ付けが終わった様子" w={1600} h={641} />
...
<Im src="20210619/switch_complete.jpg" alt="スイッチの取り付けが終わった様子" w={1600} h={628} />
...
<Im 
  src="20210619/coincellholder.jpg"
  alt="電池基板の取り付けが終わった様子"
  cap="電池基板の取り付けが終わった様子(電池ホルダ間がショートしそうだったのでテープで絶縁した)"
  w={1600}
  h={1200}
/>
...
<Im src="20210619/nomu30_complete.jpg" alt="Nomu30" w={1080} h={834} />

...
import bnaSimeji from "../../public/images/20211011/bnaSimeji.png"
import proxyman from "../../public/images/20211011/proxyman.png"
...
<Im src={bnaSimeji} alt="bnaSimejiのスクリーンショット" />
...
<Im src={proxyman} alt="ProxymanでiPhoneの通信を見る様子" cap="Spotlightを開いて「ねこ」と打ったときの通信の様子"/>
